...
<template>
    ...
    <div class="flex min-h-dvh flex-col bg-surface text-body">
        ...
        <header class="bg-enamel text-wash">
            <div class="mx-auto flex max-w-7xl items-center gap-3 px-3 py-3 sm:px-6">
                <Link :href="route('home')" class="shrink-0" aria-label="Home">
                    <BrandMark tone="light" size="sm" />
                </Link>

                <!-- Search sits in the header on every screen: this is a
                     marketplace, and finding feed is the primary job. -->
                <form
                    class="ml-auto flex min-w-0 flex-1 items-stretch sm:max-w-md"
                    role="search"
