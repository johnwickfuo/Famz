...
return [
    ...
    'backup' => [
        ...
        'destination' => [
            ...
            'disks' => [
                /*
                     * Off-server, and that is the entire point.
                     *
                     * A backup on the same VPS as the database survives a
                     * dropped table and nothing else. It does not survive the
                     * disk failing, the provider suspending the account, or
                     * somebody encrypting the filesystem — which are the three
                     * cases anybody actually needs a backup for.
                     *
                     * BACKUP_DISK names an S3-compatible disk configured in
                     * filesystems.php. It falls back to local so a fresh
                     * checkout does not fail, but a production deployment with
                     * this on local has no backup worth the name.
                     */
