...
return [
    ...
    */
    ...
    'pages' => [
        ...
        // This application capitalises the directory, so the shipped default
        // of `js/pages` finds nothing on a case-sensitive filesystem — and
        // `assertInertia()->component()` would then pass for a page that does
        // not exist.
        'paths' => [
